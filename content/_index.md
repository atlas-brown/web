...
Modern software incorporates thousands of dependencies as a means of accelerating development and reducing cost—risking safety and security for both developers and end-users. We have built a series of systems targeting the JavaScript ecosystem—the largest such ecosystem out there—automating the analysis, transformation, and synthesis of JavaScript dependencies across a variety of threat models. Examples: [OSDI'26](https://atlas.cs.brown.edu/pdf/try:osdi:2026.pdf), [AsiaCCS'23](http://nikos.vasilak.is/p/binwrap:asiaccs:2023.pdf), [CCS'21](http://nikos.vasilak.is/p/harp:ccs:2021.pdf), [CCS'21](http://nikos.vasilak.is/p/mir:ccs:2021.pdf).
